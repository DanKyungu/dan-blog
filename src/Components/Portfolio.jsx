...
const projectList = [
  {
    title: "Oversheet Package for MAUI",
    description:
      "OverSheet - is a cross platform plugin for MAUI which allow you to show a native BottomSheet coming with a fluent and native performance for each device.",
    url: "https://github.com/DanKyungu/OverSheet",
  },
  {
